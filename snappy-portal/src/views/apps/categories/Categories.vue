    ...
    <b-row>
      <b-col md="12">
        <b-row class="match-height">
          ...
          <b-col md="12" v-else-if="kitchens.length == 0" class="align-items-center">
            <h4 class="mt-3 mb-3">No Records Found</h4>
          </b-col>
          <template v-else>
            <b-col xl="4" lg="6" md="4" v-for="(item, ind) in kitchens" :key="item.id">
              <b-card no-body>
                <div class="item-img text-center">
                  <b-img
                    :alt="item.name"
                    class="card-img-top"
                    src="https://assets.savyour.com/savyour-stars/2022/10/Kababjees-Restaurant-banner.jpg"
                    height="200"
                  />
                </div>
                ...
                <b-card-body>
                  ...
                  <div class="d-flex align-items-center justify-content-between flex-wrap" v-if="false">
                    <!-- <p class="mb-0">Quantity: {{ item.quantity }}</p> -->
                    <p class="mb-0">
                      <span :class="item.quantity == 0 ? 'text-danger' : 'text-success'"
                  ...
                  <b-button variant="primary" class="btn-icon mt-2" @click="move(item.id)" block>
