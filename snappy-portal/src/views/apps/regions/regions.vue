...
export default {
  ...
  methods: {
    ...
    DeleteFlavour(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          var config = {
            method: 'delete',
            url: 'https://wishbox.fastech.pk/api/Regions/' + id,
            headers: {
    ...
    AddFlavour() {
   // return  console.log("Hello",this.myObj);
      this.CheckCity();
      this.CheckImage();
      if (
        ...
        if (this.myObj.id == 0) {
          ...
          var config = {
            method: 'post',
            url: 'https://wishbox.fastech.pk/api/Regions',
            headers: {
              Authorization: 'bearer ' + this.$store.state.userData.token,
            },
            data: this.myObj,
          ...
          axios(config)
            .then((response) => {
              if (response.data.status === 'success') {
                ...
                this.$bvToast.toast('Region added.', {
                  title: 'Success!',
                  variant: 'success',
                  toaster: 'b-toaster-bottom-center',
                });
        ...
        // return console.log(this.myObj);
          ...
          var config = {
            method: 'put',
            url:
              'https://wishbox.fastech.pk/api/Regions/'+ this.myObj.id,
            headers: {
              Authorization: 'bearer ' + this.$store.state.userData.token,
            },
            data: this.myObj,
          ...
          axios(config)
            .then((response) => {
              if (response.data.status === 'success') {
                ...
                this.$bvToast.toast('Region updated.', {
                  title: 'Success!',
                  variant: 'success',
                  toaster: 'b-toaster-bottom-center',
                });
    ...
    LoadData() {
      ...
      var categories = {
        method: 'get',
        url: 'https://wishbox.fastech.pk/api/Cities/GetRegions',
        headers: {
          Authorization: 'bearer ' + this.$store.state.userData.token,
        },
      };
