<template>
  <div class="chats">
    ...
    <div style = "background-color: #FFFFFF; border-radius: 15px; padding: 8px; margin-left:48px; width:335px"><b-img height="320" rounded alt="unicorn cake" :src="require('@/assets/images/elements/Unicorn-Cake.jpg')" /></div>
  </div>
</template>
